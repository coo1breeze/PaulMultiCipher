...
#CAESAR, SIMTRAN, MODB OR XORB?-------------------------------------------
    csmx = input("\n\nAnd do you plan to use (1) Caesar, (2) Simtran, (3) Modb or (4) Xorb Cipher?: ")
    while True:
        if csmx != '1' and csmx != '2' and csmx != '3' and csmx != '4':
            print("\nSelection invalid. Please choose again\n")
            csmx = input()
        elif csmx != '3' and csmx != '4' and txtOrImg == '2':
            print("\nCaesar and Simtran cannot be used for an image file. Please choose again\n")
            csmx = input()
        else:
            break
#----------------------------------------------------------------------------
